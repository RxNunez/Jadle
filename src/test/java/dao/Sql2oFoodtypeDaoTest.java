...
public void addFoodTypeToRestaurantAddsTypeCorrectly() throws Exception {
    ...
    assertEquals(2, foodtypeDao.getRestaurantsByFoodtype(testFoodtype.getId()).size());
}
    @Test
    public void deleteingFoodtypeAlsoUpdatesJoinTable() throws Exception {
        ...
        assertEquals(0, foodtypeDao.getRestaurantsByFoodtype(testFoodtype.getId()).size());
    }
